...
{
    /**
     * @param \App\Services\CaseStudyService $case_study_service
     */
    public function __construct( private readonly CaseStudyService $case_study_service ) {}
    ...
    public function get_posts( Request $request ): \Illuminate\Http\JsonResponse
    {
        try {
            ...
            $data = $this->case_study_service->get_posts( [
                'paged' => $paged,
                'category' => $category
            ] );
